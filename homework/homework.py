...
mlflow.set_experiment("MLflow lab 3")
#kernel{‘linear’, ‘poly’, ‘rbf’, ‘sigmoid’, ‘precomputed’} or callable, default=’rbf’
#degreeint, default=3 , class_weight, tolfloat, default=1e-3 

def optimize(pipeline,x_train,y_train,x_test,y_test):
    param_grid = {
        "pca__n_components": [21],
    "select_kbest__k": [12], #,23
    "svm__C": [0.8], #10s
    "svm__kernel": ["rbf"], #linear
    # "svm__degree": [4],
    "svm__gamma":[0.1], #,0.001
    # "svm__tol":[0.4],
    "svm__random_state":[42500],
    # "svm__class_weight":[{0:1,1:1.16}]
